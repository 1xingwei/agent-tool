...
- `docs/`: Chinese docs, flat and numbered `01`–`19` in reading order — `01` architecture overview, `02`–`07` provider and feature guides, `08`–`09` design specs, `10`–`19` engineering notes
